...
import java.util.Scanner;
	...
	final class Login {
		...
		public boolean login(String username, String password, Object obj) {
			...
			File pending = new File("C://Users//thoma//Desktop//bankApp//testing//BankingAppPt1//PendingAccounts");
			Admin a = new Admin();			
			...
			if(obj.getClass()==c.getClass()) {
				if(allFiles.getName().equals(pending.getName())){
					int i = 0;
				...
				}else {System.out.println("You Account Request is Pending...");}
			}
			return credential;
		}
